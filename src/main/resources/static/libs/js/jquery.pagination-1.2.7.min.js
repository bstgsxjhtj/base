...
!
    function(a) {
        ...
        var d, e, f, g, h, i, j, k, l, b = {
            ...
            c = function(c, d) {
                ...
                null == this.options.remote.success && (this.options.remote.success = this.options.remote.callback),
                    f = function(b) {
                        var e, f, c = b,
                            d = a('<select data-page-btn="size"></select>');
                        for (e = 0; e < c.options.pageSizeItems.length; e++) d.append('<option value="' + c.options.pageSizeItems[e] + '">' + c.options.pageSizeItems[e] + "</option>");
        ...
        c.prototype = {
            ...
            remote: function(b, c) {
                var e, f, d = this; (isNaN(parseInt(b)) || "object" == typeof b) && (c = b, b = null),
                ...
                c && (c = i(c), this.options.remote.params = a.extend({},
                    this.options.remote.params, c)),
                    f = a.extend({},
                        this.options.remote.params, e),
                    a.ajax({
                        ...
                        success: function(a) {
                            ...
                            null == c || void 0 == c ? console && console.error("the response of totalName :  '" + d.options.remote.totalName + "'  not found") : (d._updateTotal(c), "function" == typeof d.options.remote.success && d.options.remote.success(a, b), d.renderPagination(b))
                        }
                    })
            },
            renderPagination: function(a) {
                ...
                this.$page.empty().append(b),
                    ...
                    this.pageCount > 1 ? (this.$page.show(), this.options.showPageSizes && this.$size.show(), this.options.showJump && this.$jump.show(), this.options.showInfo && this.$info.show()) : 1 == this.pageCount ? this.options.showInfo && this.$info.show() : (this.$page.hide(), this.$size.hide(), this.$jump.hide(), this.$info.hide())
            },
            ...
            debug: function(a, b) {
                this.options.debug && console && (a && console.info(a), b && console.info(b))
            }
        },
            d = function(a, b, c, d) {
                var e = a * b + 1,
            ...
            e = function(a, b, c, d, e, i, j, k, l) {
                ...
                return a = void 0 == a ? 1 : parseInt(a) + 1,
                    m = h(c, b),
                    n = [],
                    d >= m ? n = f(1, m, a) : (o = g(e || 1, 0), p = g(i || m, m - 1), q = g(j, a - 2), r = g(k, a), s = (d - 1 - 4) / 2, l || (s += 1), t = (d + 1) / 2, u = m - (d + 1) / 2, s = -1 == s.toString().indexOf(".") ? s: s + .5, t = -1 == t.toString().indexOf(".") ? t: t + .5, u = -1 == u.toString().indexOf(".") ? u: u + .5, t >= a ? l ? (n = f(1, d - 2, a), n.push(r), n.push(p)) : (n = renderPagenderPage(1, d - 1, a), n.push(r)) : a > u ? l ? (n = f(m - d + 3, d - 2, a), n.unshift(q), n.unshift(o)) : (n = f(m - d + 2, d - 1, a), n.unshift(q)) : l ? (n = f(a - s, d - 4, a), n.unshift(q), n.push(r), n.unshift(o), n.push(p)) : (n = f(a - s, d - 2, a), n.unshift(q), n.push(r))),
                    n
            },
            f = function(a, b, c) {
                var e, f, d = [];
                for (e = 0; b > e; e++) f = g(a, a - 1),
            ...
            i = function(a) {
                var c, d, e, b = {};
                if ("string" == typeof a) for (c = a.split("&"), d = 0; d < c.length; d++) e = c[d].split("="),
                    b[e[0]] = decodeURIComponent(e[1]);
                else if (a instanceof Array) for (d = 0; d < a.length; d++) b[a[d].name] = decodeURIComponent(a[d].value);
            ...
            l = function(a, b) {
                for (var c in a) if (c == b) return a[c];
                return null
            },
            a.fn.page = function(b) {
                ...
                return this.each(function() {
                    var g, h, e = a(this),
                        f = e.data("page");
                    f || "object" != typeof b && "undefined" != typeof b ? f && "string" == typeof b ? f[b].apply(f, Array.prototype.slice.call(d, 1)) : f || console && console.error("jQuery Pagination Plugin is uninitialized.") : (g = "object" == typeof b && b, h = e.data(), g = a.extend(g, h), e.data("page", f = new c(this, g)))
                })
            }
    } (window.jQuery);